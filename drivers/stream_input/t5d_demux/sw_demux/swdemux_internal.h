...
struct swdmx_descrambler {
    struct swdmx_list chan_list; /**< Descrambler channel list.*/
    struct swdmx_list cb_list;   /**< Callback list.*/
};
...
struct swdmx_descchannel {
    struct swdmx_list ln; /**< List node data.*/
	int    enable;        /**< The channel is enabled.*/
    u16    pid;           /**< PID of the stream.*/
	int    scb_as_is;     /**< Keep SCB flags.*/
	int    scb;           /**< New SCB flags.*/
	struct swdmx_key *odd_key;  /**< Odd key.*/
	struct swdmx_key *even_key; /**< Even key.*/
	struct swdmx_key *zero_key; /**< 00 key.*/
	struct swdmx_key *odd_iv;   /**< Odd IV data.*/
	struct swdmx_key *even_iv;  /**< Even IV data.*/
	struct swdmx_key *zero_iv;  /**< 00 IV data.*/
	swdmx_desc_cb desc_cb;      /**< Descrambling callback.*/
};

/**PES parser.*/
struct swdmx_pesparser {
	int start;       /**< The PES started.*/
	int ts_scramble; /**< TS is scrambled.*/
    struct swdmx_pespacket pkt;     /**< The packet.*/
    struct swdmx_list      cb_list; /**< Callback list.*/
};
