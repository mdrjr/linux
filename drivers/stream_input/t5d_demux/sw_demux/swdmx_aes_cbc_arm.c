...
static void
aes_cbc_dec_desc_pkt (struct arm_aes_key *key, u8 *iv, struct swdmx_tspacket *pkt)
{
    u8 *p    = pkt->payload;
    ...
    arm_aes_cbc_decrypt(in, out, len, key, ivbuf);
